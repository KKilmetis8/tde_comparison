...
if plot == 'spectra':
    ...
    if m == 4:
        ...
        plt.plot(n_array, L_tilda_n233, c = 'tomato', label = 't/$t_{fb}$ = 1')
        plt.plot(n_array, L_tilda_n254, c = 'orange', label = 't/$t_{fb}$ = 1.2')
        plt.plot(n_array, L_tilda_n263, c = 'yellowgreen', label = 't/$t_{fb}$ = 1.3')
